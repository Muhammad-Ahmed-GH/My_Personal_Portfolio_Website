...
export default function ContactCard(props: Props) {
  ...
  return (
    <div className="w-full max-w-full p-[55px_20px] border-1 border-card-border rounded-[var(--spacing-border-r)] text-center bg-card transition-[background_transform] duration-[var(--main-transition)] cursor-pointer sm:w-[350px] hover:transform-[translateY(-5px)] hover:bg-card-hover">
